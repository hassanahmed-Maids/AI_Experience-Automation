...
module.exports = {
  score,
  // exported for the test harness and for the n8n build to import the same constants
  REFUND_WINDOW_DAYS, REFUNDABLE_HIGH, REFUNDABLE_LOW, AMOUNT_BAND_BOUNDARY,
  KNOWN_REFUND_AMOUNTS, BOOKING_SKEW_TOLERANCE_DAYS, EARLIEST_SUPPORTED_DATE,
  CHARGE_PURPOSES, REFUND_PURPOSES, FOREIGN_REFUND_PURPOSES,
  EXPENSE_STATUS, REJECTED, TASK_COMPLETE, VERDICT,
  _internal: { purposeClass, isEntryVisaCharge, isEntryVisaRefund, chargeIsPaid, rejectionForCharge, valueFinding }
};
