...
// its batch on unchanged. Build Evidence Bundle reads $('Get Sales Todo Notes') by name and is
...
erpBreakerGuard({
  phase: 'Sales to-do notes (CC Non Received 2-Verify)',
  key: 'sales_todo_notes',
...
// $('Get Sales Todo Notes') by name, so it neither sees nor cares about this node.
return $input.all();
