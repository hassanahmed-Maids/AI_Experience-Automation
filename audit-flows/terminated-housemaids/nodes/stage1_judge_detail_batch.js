...
// the breaker at the top of Resolve Maids, which is 8.5 KB of identity logic - a generated
...
erpBreakerGuard({
  phase: 'Transaction detail (Terminated HM 1-Score)',
  key: 'detail',
...
// Pass the batch on untouched. Resolve Maids reads $('Get Transaction Detail') by name, so it is
