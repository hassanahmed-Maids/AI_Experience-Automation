<!-- POSTED 2026-08-30 as SD-67697, since routed to MC-1996 (status: Pending PO).
     Notion status: "On Jira pending production".
     Production export: audit-flows/jira/exports/cc-overstay-fines.prod.json (62 nodes,
     lease nodes removed and the staging ERP credential detached). -->
