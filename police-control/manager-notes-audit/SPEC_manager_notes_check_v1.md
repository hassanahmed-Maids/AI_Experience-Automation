...
| **B3b** | 🔴 **OPEN WITH MANAGEMENT — may an anti-attrition incentive be paid to a maid who has ABSCONDED or been terminated by the payment date?** **110 notes, AED 13,257.** ⚠️ **RESHAPED 2026-09-15 — do NOT put this as one yes/no.** Prorating each note against the days she was actually eligible (`queries/anti-attrition-abscondment-cases.sql`) shows **AED 10,210 of the 13,257 is money she had already worked for**; only **AED 1,612.90, across three maids, is for days after she left**. Ask three questions instead: **(i)** when a maid absconds mid-month, does she forfeit the whole month's incentive or keep the prorated part she worked? — this alone moves the row between 13,257 and 1,613; **(ii)** may a maid be **ENROLLED** while already absent? maid 73378 absconded 2025-09-24 and was enrolled 2025-10-07, *thirteen days after*, then paid a full AED 200 three months running; **(iii)** must eligibility be re-checked **between cycles**, not only at selection? both band-B maids were paid full, unprorated months every cycle after they left. (ii) and (iii) are defects the select-once framing hides — they are not the same hole | Requestor → management | **Yes** |
