...
| O9 | ~~grp3 / grp4~~ **CLOSED 2026-09-03, and our earlier answer was wrong.** The detailed payroll file has day counts for **all six** groups; earnings columns exist for grp1, grp2, grp4, grp5 and grp6 — there is no grp3 earnings column. **grp4 is vacation salary** (`HousemaidPayrollLog.vacationSalary`). So M5 excludes grp4 for a real reason — vacation pay does not belong in an accommodation ratio — not because the groups are absent | — |
