...
| **Status** | Draft — decisions in §6 outstanding. **v6 changes the shape of the check; read §0 first.** |

---

## 0. What changed in v6, and why it matters
...
🔴 **Build-time measurement required:** the visa validity actually issued, per case, to separate "we overpaid by 100" from "the visa was cancelled early". Until that is read, these 25 are **AMBER with reason `term-mismatch-unverified`**, never RED.
